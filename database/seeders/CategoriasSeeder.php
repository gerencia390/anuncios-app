...
class CategoriasSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('categorias')->insert([
            ...
            ['cat_nombre' => 'ANTICRETICO', 'cat_letra_codigo' => 'A', 'cat_descripcion' => 'Anticretico de inmuebles', 'cat_activo' => true, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['cat_nombre' => 'VARIOS', 'cat_letra_codigo' => 'V', 'cat_descripcion' => 'Otros anuncios', 'cat_activo' => true, 'created_at' => now(), 'updated_at' => now()],
        ]);
    }
}
