...
<div class="col-md-10 content-pane">
    <div class="title-container">
        <div class="row">
            ...
            <div class="col-6">
					<a href="{{secure_url('anuncios')}}" title="Volver a lista de anuncios" data-placement="bottom" class="btn btn-sm btn-secondary float-right" style="margin-left:10px;"><i class="fa fa-angle-double-left"></i> ATRÁS</a>
			</div>
		</div>
	</div>			
