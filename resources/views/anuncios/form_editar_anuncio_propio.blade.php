									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input autofocus required type="text" value="{{ old('anu_concepto', $anuncio->anu_concepto) }}" class="form-control @error('anu_concepto') is-invalid @enderror" name="anu_concepto" id="anu_concepto" placeholder="Concepto del anuncio">
												@error('anu_concepto')
											...
											<div class="form-group">
												...
												<textarea class="form-control @error('anu_descripcion') is-invalid @enderror" name="anu_descripcion" id="anu_descripcion" placeholder="Copiar de la ficha técnica resumida">{{ old('anu_concepto', $anuncio->anu_descripcion) }}</textarea>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<input required type="text" value="{{ old('anu_codigo_anuncio', $anuncio->anu_codigo_anuncio) }}" class="form-control @error('anu_codigo_anuncio') is-invalid @enderror" name="anu_codigo_anuncio" id="anu_codigo_anuncio" placeholder="Código SUPERCASAS (Ej.: RS-F-123)">
											...
											<div class="form-group">
												...
												<input required type="date" value="{{ old('anu_fecha_anuncio', $anuncio->anu_fecha_inicio) }}" class="form-control @error('anu_fecha_inicio') is-invalid @enderror" name="anu_fecha_inicio" id="anu_fecha_inicio" placeholder="Fecha de contrato">
											...
											<div class="form-group">
												...
												<input required type="text" value="{{ old('anu_telefonos_contacto', $anuncio->anu_telefonos_contacto) }}" class="form-control @error('anu_telefonos_contacto') is-invalid @enderror" name="anu_telefonos_contacto" id="anu_telefonos_contacto" placeholder="Teléfonos de contacto del asesor de captación.">
...
$(function(){
    ...
    $('#anu_codigo_anuncio').on('change', function () {
