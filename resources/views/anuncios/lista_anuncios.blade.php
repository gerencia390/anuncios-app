...
<div class="col-md-10 content-pane">
    <div class="title-container">
        <div class="row">
            ...
            <div class="col-6">
                <a href="{{secure_url('anuncios/nuevo')}}" class="btn btn-sm btn-success float-right" style="margin-left:10px;"><i class="fa fa-plus"></i> NUEVO ANUNCIO</a>
                                ...
                                <td>
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" href="{{secure_url('anuncios/'.Crypt::encryptString($item->anu_id).'/editar')}}"><i class="fa fa-edit"></i> Editar anuncio</a>
...
<div class="modal fade" id="modal-finalizar-anuncio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times"></i> Cerrar</button>
          <form id="form-finalizar-anuncio" action="{{secure_url('anuncios')}}" data-simple-action="{{secure_url('anuncios/finalizar')}}" method="post">
            @method('post')
            @csrf
...
<div class="modal fade" id="modal-eliminar-anuncio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times"></i> Cerrar</button>
          <form id="form-eliminar-anuncio" action="{{secure_url('anuncios')}}" data-simple-action="{{secure_url('anuncios')}}" method="post">
            @method('delete')
            @csrf
