        ...
        <div class="col-12">              
                ...
                <div class="card card-stat">
                    <div class="card-body">
                        ...
                        @else
                        <table class="table table-bordered tabla-datos-anuncios">
                            <thead>
                            <tr>
                                <th>CODIGO</th>
                                <th>TIPO</th>
                            ...
                            <tr>
                                <td class="text-center">
                                    @foreach ($categorias as $itemCat)
                                        @if ($item->cat_id == $itemCat->cat_id)
                                            {{ $itemCat->cat_letra_codigo }}
                                        @endif                                         
                                    @endforeach 
                                    -
                                ...
                                <td class="text-center">
                                    @if($item->anu_estado == 0)
                                        <span class="badge badge-secondary">GUADADO</span>
                                    @endif
