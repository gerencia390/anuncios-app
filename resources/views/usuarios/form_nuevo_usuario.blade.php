											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input required type="text" value="{{old('usu_nombre')}}" class="form-control @error('usu_nombre') is-invalid @enderror" name="usu_nombre" id="usu_nombre" placeholder="Nombre de usuario">
														@error('usu_nombre')
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input required type="text" value="{{old('usu_password', Str::random(20))}}" class="form-control txt_pwd @error('usu_password') is-invalid @enderror" name="usu_password" id="usu_password" readonly>
														@error('usu_password')
														<div class="invalid-feedback">
															{{$message}}
														</div>											
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input required type="text" value="{{old('usu_nombre_completo', )}}" class="form-control @error('usu_nombre_completo') is-invalid @enderror" name="usu_nombre_completo" id="usu_nombre_completo" placeholder="Nombres y apellidos">
