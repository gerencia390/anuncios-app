...
<div class="col-md-10 content-pane">
    <h3 class="title-header" style="text-transform: uppercase;">
        ...
        {{$titulo}}
        {{-- <a href="#" class="btn btn-sm btn-dark float-right" style="margin-left:10px;" data-toggle="modal" data-target="#modal-eliminar-proveedor"><i class="fa fa-arrow-up"></i> SALIDA MANUAL</a> --}}
                                ...
                                <td>
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{url('proveedores/'.Crypt::encryptString($item->usu_id).'/editar')}}"><i class="fa fa-edit"></i> Editar</a>
